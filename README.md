...
```javascript
import isAbsoluteURI from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-absolute-uri@v0.2.3-esm/index.mjs';
```
...
[@stdlib/assert/is-relative-uri]: https://github.com/stdlib-js/assert-is-relative-uri/tree/esm
